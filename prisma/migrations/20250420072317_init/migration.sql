...
-- CreateIndex
CREATE UNIQUE INDEX "PaymentSession_pidx_key" ON "PaymentSession"("pidx");
...
-- AddForeignKey
ALTER TABLE "PaymentSession" ADD CONSTRAINT "PaymentSession_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "Event"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
